				...
				<div id="container">
					...
					<div id="header" class="clearfix">
						...
						<div id="upper-wrap" class="clearfix">			
							<!-- BEGIN #logo -->
							<div id="logo">
								<a href="http://ebay.golden-contact-computing.co.uk/"><img src="images/ebay_logo1.jpg" alt="EBAY"></a>
							<!-- END #logo -->
							</div>
							<!-- BEGIN #primary-nav -->
							<div id="primary-nav">
 ...
 padding-top:0px; border:none;">					                        
	...
	*/
	private function createContentHtmlStart() {
		...
		if ($this->pageVars["browser"] == "ie") {
		$htmlvar .= '<script type="text/javascript">alert("There are reported issues with IE. Please use Firefox or Chrome")</script>';
		}
	return $htmlvar ;
