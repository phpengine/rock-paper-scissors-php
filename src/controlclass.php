...
class EbayRPSGameControlClass {
	...
	*/
	private function getPage() {
		if ($this->route["action"]=="cv") {
			...
			$this->pageVars["content"] = file_get_contents("pages/hi.php");
	...
	*/
	private function calculateWinner($player1, $player2) {
		$possibilities = array();
		$possibilities["scissors"] = array( "rock" => "lose", "paper" =>"win" );
		$possibilities["rock"] = array( "paper" => "lose", "scissors" =>"win" );
		$possibilities["paper"] = array( "scissors" => "lose", "rock" =>"win" );
